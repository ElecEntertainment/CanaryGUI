...
public class CanaryGUIKeyEventListener extends KeyAdapter {

    private final JTextField textField;
    private final CommandLog commandlog;
    private final AutoCommands autocommands;

    public CanaryGUIKeyEventListener(CommandLog commandlog, AutoCommands autocommands, JTextField textField) {
